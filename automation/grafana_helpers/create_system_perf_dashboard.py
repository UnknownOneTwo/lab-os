...
NEW_TITLE = f"System Performance Monitor v1.1 ({timestamp})"
...
try:
    ...
    print("🔗 Title:", response_json["dashboard"]["title"])
    print("🆔 UID:", response_json["uid"])
    print("📂 URL:", f"{GRAFANA_URL}/d/{response_json['uid']}")
except Exception as e:
    print(f"❌ Error: {e}")
    print("🛠️ Full API Response:")
    print(response.text)
